...
Sign in to openwrt > `system menu` > `file transfer` > `upload`, and upload [the original firmware file of Linksys wrt1900 ACS](https://www.linksys.com/cn/support-article?articleNum=226203) as [FW_WRT32X_1.0.180404.58.img](https://downloads.linksys.com/downloads/firmware/FW_WRT32X_1.0.180404.58.img), 
