...
The latest version of the firmware is automatically compiled every Friday at 0:00 UTC, and automatically generated using GitHub Actions, which can be downloaded in [Action](https://github.com/ophub/op/actions). For detailed information about each firmware, please refer to the description of each model. The currently supported router models are: 
