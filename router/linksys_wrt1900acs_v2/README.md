You can download the OpwnWrt for Linksys WRT1900ACS firmware from Actions. Such as Build Linksys WRT1900ACS v1 & v2 (shelby) OpenWrt Firmware. Unzip to get the IMG file.
