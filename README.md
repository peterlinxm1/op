...
The latest version of the OpenWrt firmware is automatically compiled everyday at 20:00 UTC, Build OpenWrt using GitHub Actions, which can be downloaded in [Releases](https://github.com/ophub/op/releases) & [Action](https://github.com/ophub/op/actions). For detailed information about each firmware, please refer to the README.md file of each model. The currently supported router models are: 
