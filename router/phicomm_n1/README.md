...
Writing method: `log in to openwrt` > `system menu` > `TTYD terminal` > input command: ```diff + n1-install ```, you can input the firmware in the USB hard disk to the EMMC partition of Phicomm N1.
